...
```
```
programmed by: Safeeq Fazil.A
reg no: 212222240086
```

## Output screen shots of proteus  :
When PushButton is not pressed:
![exp 6 1](https://github.com/Safeeq-Fazil/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118680361/4bf401ac-3e96-4445-95af-f92fad270b95)

when pushbutton is pressed:
![exp 6 2](https://github.com/Safeeq-Fazil/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118680361/425c8877-43c0-4662-aad3-2b89825f25e0)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![exp 6](https://github.com/Safeeq-Fazil/EXPERIMENT-06-INTERRUPT-GENERATION-USING-PUSHBUTTON-AND-SIMULATING-THE-OUTPUT-/assets/118680361/38d33183-9e57-4d41-8f7e-4c77cabafe88)
